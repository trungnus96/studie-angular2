...
var UserService = (function () {
    function UserService(http, router) {
        this.http = http;
        this.router = router;
        this.url = "https://ancient-ocean-55048.herokuapp.com/users/";
        // private url = "users/";
...
var DegreeService = (function () {
    function DegreeService(http) {
        this.http = http;
        this.url = "https://ancient-ocean-55048.herokuapp.com/degree/";
        // private url = "degree/";
        this.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
    }
...
var SchoolService = (function () {
    function SchoolService(http) {
        this.http = http;
        this.url = "https://ancient-ocean-55048.herokuapp.com/school/";
        // private url = "school/";
        this.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
    }
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.userService.validateAdmin(JSON.parse(localStorage.getItem('user')).id)
            ...
            if (data.success) {
                ...
                //get marks
                _this.markService.getMarksByUsername(JSON.parse(localStorage.getItem('user')).username)
                    .subscribe(function (data) {
                    _this.marks = data.marks;
                    _this.isLoading_mark = false;
                    if (_this.marks.length != 0) {
...
var MarkService = (function () {
    function MarkService(http) {
        this.http = http;
        this.url = "https://ancient-ocean-55048.herokuapp.com/mark/";
        // private url = "mark/";
        this.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
    }
    ...
    MarkService.prototype.getMarksByUsername = function (user_id) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Authorization', this.getToken());
        headers.append('Content-Type', 'application/json');
