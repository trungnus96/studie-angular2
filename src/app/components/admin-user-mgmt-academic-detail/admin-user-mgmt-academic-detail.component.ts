...
@Component({
  ...
  templateUrl: './admin-user-mgmt-academic-detail.component.html',
  styleUrls: ['./admin-user-mgmt-academic-detail.component.css']
})
export class AdminUserMgmtAcademicDetailComponent implements OnInit {
