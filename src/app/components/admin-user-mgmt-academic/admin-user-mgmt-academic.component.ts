...
import {AdminUserMgmtProfileComponent} from '../admin-user-mgmt-profile/admin-user-mgmt-profile.component'
declare var $: any;

@Component({
  selector: 'app-admin-user-mgmt-academic',
  templateUrl: './admin-user-mgmt-academic.component.html',
  styleUrls: ['./admin-user-mgmt-academic.component.css']
})
export class AdminUserMgmtAcademicComponent implements OnInit {
